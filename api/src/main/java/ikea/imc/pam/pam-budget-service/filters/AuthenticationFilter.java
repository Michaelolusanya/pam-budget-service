package org.imc.pam.boilerplate.filters;
...
import org.imc.pam.boilerplate.security.JWTVerifier;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (isCurrentPathOpen(req.getRequestURI(), req.getMethod())) {
    ...
    void send401Response(HttpServletResponse response) throws ServletException, IOException {
        ...
        Object body = new ResponseMsg(401).getBody();
