...
import static com.ikea.imc.pam.budget.service.client.dto.Constants.*;
...
class RestEndpointTests extends AbstractBaseTest {
    ...
    class CreateExpensesTest {
        ...
        void createExpenseWithMissingBudget() {
            ...
            // WHEN (REST call to budget-service to update expenses for a budget)
            var exception =
                assertThrows(ClientRequestException.class, () -> budgetClient.createExpense(0L, expenseToBeCreated));
        ...
        void createExpenseWithDeletedBudget() {
            ...
            // WHEN (REST call to budget-service to update expenses for a budget)
            var exception = assertThrows(ClientRequestException.class,
    ...
    class BudgetAreaRestEndpointTests extends AbstractBaseTest {
        ...
        class GetBudgetAreaTest {
            ...
            void notFoundBudgetArea() {
                ...
                // When
                ClientRequestException requestException =
                    assertThrows(ClientRequestException.class, () -> budgetClient.getBudgetArea(budgetAreaId));
        ...
        class FindBudgetAreaTest {
            ...
            void existingBudgetArea() {
                ...
                // When
                Optional<BudgetAreaDTO> optionalBudgetArea = budgetClient.findBudgetArea(existingDTO.parentType(),
                    existingDTO.parentId(),
                    existingDTO.fiscalYear()
                );
            ...
            void notFoundBudgetArea() {
                ...
                // When
                ClientRequestException requestException = assertThrows(
                    ClientRequestException.class,
                    () -> budgetClient.findBudgetArea(parentType, parentId, fiscalYear)
                );
            ...
            void invalidSearchParameters() {
                ...
                assertTrue(responseMessage.getErrors()
                    .stream()
                    .anyMatch(error -> "fiscalYear".equals(error.getPointer())));
                assertTrue(responseMessage.getErrors()
                    .stream()
                    .anyMatch(error -> "parentId".equals(error.getPointer())));
            }
        }
        ...
        class PutBudgetAreaTest {
            ...
            void newBudgetArea() {
                ...
                // Given
                BudgetAreaDTO toCreateDto = BudgetAreaDTO.builder()
                    .parentId(1234L)
            ...
            void invalidBudgetArea() {
                ...
                // Given
                BudgetAreaDTO dto =
                    BudgetAreaDTO.builder().parentType(null).parentId(-1L).fiscalYear(-1).costLimit(-1L).build();
                
                // When
                ClientRequestException exception =
                    assertThrows(ClientRequestException.class, () -> budgetClient.putBudgetArea(dto));
                ...
                assertTrue(responseMessage.getErrors()
                    .stream()
                    .anyMatch(error -> "parentType".equals(error.getPointer())));
                assertTrue(responseMessage.getErrors()
                    .stream()
                    .anyMatch(error -> "parentId".equals(error.getPointer())));
                assertTrue(responseMessage.getErrors()
                ...
                assertTrue(responseMessage.getErrors()
                    .stream()
                    .anyMatch(error -> "costLimit".equals(error.getPointer())));
            }
        }
